...
### spawn-smoke QUARANTINE map (e2e/tests/io-spec-consistency.spec.ts) — 4
...
- `e2e/tests/workflow-shell-video.spec.ts:962` — no videoinput device in this runtime — device-list assert not applicable
