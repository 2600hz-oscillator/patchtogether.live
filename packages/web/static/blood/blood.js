...
async function loadBlood(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('blood.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('blood.wasm', import.meta.url).href;
...
var _free,
  ...
  _bpt_init,
  _bpt_tick,
  _bpt_get_framebuffer,
  _bpt_get_framebuffer_size,
  _bpt_get_resx,
  _bpt_get_resy,
  _bpt_has_frame,
  _bpt_pump_audio,
  _bpt_get_pcm_buffer,
  _bpt_get_pcm_buffer_size,
...
function assignWasmExports(wasmExports) {
  ...
  _bpt_set_key = Module['_bpt_set_key'] = wasmExports['bpt_set_key'];
  _bpt_init = Module['_bpt_init'] = wasmExports['bpt_init'];
  _bpt_tick = Module['_bpt_tick'] = wasmExports['bpt_tick'];
  _bpt_get_framebuffer = Module['_bpt_get_framebuffer'] = wasmExports['bpt_get_framebuffer'];
  _bpt_get_framebuffer_size = Module['_bpt_get_framebuffer_size'] = wasmExports['bpt_get_framebuffer_size'];
  _bpt_get_resx = Module['_bpt_get_resx'] = wasmExports['bpt_get_resx'];
  _bpt_get_resy = Module['_bpt_get_resy'] = wasmExports['bpt_get_resy'];
  _bpt_has_frame = Module['_bpt_has_frame'] = wasmExports['bpt_has_frame'];
  _bpt_pump_audio = Module['_bpt_pump_audio'] = wasmExports['bpt_pump_audio'];
  _bpt_get_pcm_buffer = Module['_bpt_get_pcm_buffer'] = wasmExports['bpt_get_pcm_buffer'];
  _bpt_get_pcm_buffer_size = Module['_bpt_get_pcm_buffer_size'] = wasmExports['bpt_get_pcm_buffer_size'];
  ...
  dynCall_jiijii = dynCalls['jiijii'] = wasmExports['dynCall_jiijii'];
  ...
  _shlookup = Module['_shlookup'] = wasmExports['shlookup'].value;
  _sqrtable = Module['_sqrtable'] = wasmExports['sqrtable'].value;
  _sqrtable_old = Module['_sqrtable_old'] = wasmExports['sqrtable_old'].value;
  _pow2char_ = Module['_pow2char_'] = wasmExports['pow2char_'].value;
}
