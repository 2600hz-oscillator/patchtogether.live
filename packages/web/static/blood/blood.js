...
var ASM_CONSTS = {
 ...
 255374: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 255457: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 255526: () => { return window.innerWidth; },  
 255556: () => { return window.innerHeight; },  
 255587: ($0, $1) => { alert(UTF8ToString($0) + "\n\n" + UTF8ToString($1)); }
};
