...
Eroded terrain island — COMMON tab (shared GLSL prepended to every pass).
Ported VERBATIM from Shadertoy for TOYBOX's multi-buffer Shadertoy runtime.

See Buffer B for information on the erosion technique.

Advanced Terrain Erosion Filter / Phacelle Noise copyright (c) 2025 Rune Skovbo
Johansen, MPL-2.0 (https://mozilla.org/MPL/2.0/). Terrain rendering derived from
https://www.shadertoy.com/view/7ljcRW by Fewes.
