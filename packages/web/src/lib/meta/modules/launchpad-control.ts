...
// per-machine and never synced. The Launchpad Mk3 proposal it was built from was
// authored on the unmerged branch `origin/docs/launchpad-mk3-proposal`
// (d7b40c1589) — it never reached main, so it is in no preservation tag and a
// branch prune takes it with no trace. ADR-011 above is the only durable
// authority for this module's lifetime decision.
//
