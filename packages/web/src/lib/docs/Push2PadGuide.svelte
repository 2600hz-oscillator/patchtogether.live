...
<section id="pad-modes" class="pad-guide" data-testid="push2-pad-guide">
  ...
  {:else if mode === 'keys'}
    ...
    <p>Recorded onsets follow the capture grid, while note releases preserve how long you held each key, including durations between steps, up to the clip’s end. Those captured durations override the global GATE duty. See <a href="/docs/modules/clipplayer#notes">note lengths and screen ties</a>.</p>
