...
export const MODULE_DOCS: Record<string, ModuleDocs> = {
  ...
  "hydrogen": {
    "explanation": "A multi-kit 16-instrument × 16-step drum machine (named after the open-source Hydrogen sequencer). Each of 16 instrument rows holds a 16-step on/off pattern grid; the playhead walks the steps at the BPM tempo (or an external CLOCK IN) and fires each lit step's drum voice. Pick a kit (TR-808 / TR-909 / LinnDrum / CR-78 / …) with the kit button; every instrument has its own VOLUME, PAN, PITCH, a per-voice low-pass FILTER (cutoff + Q), a full amp ADSR, and MUTE/SOLO — exposed by clicking an instrument's name to expand its knob strip (the patch panel also carries every per-voice CV input + direct TRIG). The whole transport (play/stop, reset, 4 preset slots) is drivable hands-free via the CV inputs, and SWING shuffles the groove. Output is a stereo mix (out_l/out_r) through the master GAIN. Each instrument can also be triggered directly by a gate on its trig{i} input, bypassing the grid — so you can drive HYDROGEN purely as a 16-voice sample player from external sequencers.",
    "inputs": {
      "clock_in": "External clock: each rising edge advances the pattern playhead one step (16th-note cell). Patch a clock here and the internal BPM is ignored — the incoming pulses set the pace.",
      "cv_a_0": "CV that offsets instrument 1's envelope ATTACK (log).",
      "cv_a_1": "CV that offsets instrument 2's envelope ATTACK (log).",
      "cv_a_10": "CV that offsets instrument 11's envelope ATTACK (log).",
      "cv_a_11": "CV that offsets instrument 12's envelope ATTACK (log).",
      "cv_a_12": "CV that offsets instrument 13's envelope ATTACK (log).",
      "cv_a_13": "CV that offsets instrument 14's envelope ATTACK (log).",
      "cv_a_14": "CV that offsets instrument 15's envelope ATTACK (log).",
      "cv_a_15": "CV that offsets instrument 16's envelope ATTACK (log).",
      "cv_a_2": "CV that offsets instrument 3's envelope ATTACK (log).",
      "cv_a_3": "CV that offsets instrument 4's envelope ATTACK (log).",
      "cv_a_4": "CV that offsets instrument 5's envelope ATTACK (log).",
      "cv_a_5": "CV that offsets instrument 6's envelope ATTACK (log).",
      "cv_a_6": "CV that offsets instrument 7's envelope ATTACK (log).",
      "cv_a_7": "CV that offsets instrument 8's envelope ATTACK (log).",
      "cv_a_8": "CV that offsets instrument 9's envelope ATTACK (log).",
      "cv_a_9": "CV that offsets instrument 10's envelope ATTACK (log).",
      "cv_cf_0": "CV that offsets instrument 1's filter CUTOFF (log).",
      "cv_cf_1": "CV that offsets instrument 2's filter CUTOFF (log).",
      "cv_cf_10": "CV that offsets instrument 11's filter CUTOFF (log).",
      "cv_cf_11": "CV that offsets instrument 12's filter CUTOFF (log).",
      "cv_cf_12": "CV that offsets instrument 13's filter CUTOFF (log).",
      "cv_cf_13": "CV that offsets instrument 14's filter CUTOFF (log).",
      "cv_cf_14": "CV that offsets instrument 15's filter CUTOFF (log).",
      "cv_cf_15": "CV that offsets instrument 16's filter CUTOFF (log).",
      "cv_cf_2": "CV that offsets instrument 3's filter CUTOFF (log).",
      "cv_cf_3": "CV that offsets instrument 4's filter CUTOFF (log).",
      "cv_cf_4": "CV that offsets instrument 5's filter CUTOFF (log).",
      "cv_cf_5": "CV that offsets instrument 6's filter CUTOFF (log).",
      "cv_cf_6": "CV that offsets instrument 7's filter CUTOFF (log).",
      "cv_cf_7": "CV that offsets instrument 8's filter CUTOFF (log).",
      "cv_cf_8": "CV that offsets instrument 9's filter CUTOFF (log).",
      "cv_cf_9": "CV that offsets instrument 10's filter CUTOFF (log).",
      "cv_d_0": "CV that offsets instrument 1's envelope DECAY (log).",
      "cv_d_1": "CV that offsets instrument 2's envelope DECAY (log).",
      "cv_d_10": "CV that offsets instrument 11's envelope DECAY (log).",
      "cv_d_11": "CV that offsets instrument 12's envelope DECAY (log).",
      "cv_d_12": "CV that offsets instrument 13's envelope DECAY (log).",
      "cv_d_13": "CV that offsets instrument 14's envelope DECAY (log).",
      "cv_d_14": "CV that offsets instrument 15's envelope DECAY (log).",
      "cv_d_15": "CV that offsets instrument 16's envelope DECAY (log).",
      "cv_d_2": "CV that offsets instrument 3's envelope DECAY (log).",
      "cv_d_3": "CV that offsets instrument 4's envelope DECAY (log).",
      "cv_d_4": "CV that offsets instrument 5's envelope DECAY (log).",
      "cv_d_5": "CV that offsets instrument 6's envelope DECAY (log).",
      "cv_d_6": "CV that offsets instrument 7's envelope DECAY (log).",
      "cv_d_7": "CV that offsets instrument 8's envelope DECAY (log).",
      "cv_d_8": "CV that offsets instrument 9's envelope DECAY (log).",
      "cv_d_9": "CV that offsets instrument 10's envelope DECAY (log).",
      "cv_pan_0": "CV that offsets instrument 1's PAN (linear).",
      "cv_pan_1": "CV that offsets instrument 2's PAN (linear).",
      "cv_pan_10": "CV that offsets instrument 11's PAN (linear).",
      "cv_pan_11": "CV that offsets instrument 12's PAN (linear).",
      "cv_pan_12": "CV that offsets instrument 13's PAN (linear).",
      "cv_pan_13": "CV that offsets instrument 14's PAN (linear).",
      "cv_pan_14": "CV that offsets instrument 15's PAN (linear).",
      "cv_pan_15": "CV that offsets instrument 16's PAN (linear).",
      "cv_pan_2": "CV that offsets instrument 3's PAN (linear).",
      "cv_pan_3": "CV that offsets instrument 4's PAN (linear).",
      "cv_pan_4": "CV that offsets instrument 5's PAN (linear).",
      "cv_pan_5": "CV that offsets instrument 6's PAN (linear).",
      "cv_pan_6": "CV that offsets instrument 7's PAN (linear).",
      "cv_pan_7": "CV that offsets instrument 8's PAN (linear).",
      "cv_pan_8": "CV that offsets instrument 9's PAN (linear).",
      "cv_pan_9": "CV that offsets instrument 10's PAN (linear).",
      "cv_pi_0": "CV that offsets instrument 1's PITCH (linear).",
      "cv_pi_1": "CV that offsets instrument 2's PITCH (linear).",
      "cv_pi_10": "CV that offsets instrument 11's PITCH (linear).",
      "cv_pi_11": "CV that offsets instrument 12's PITCH (linear).",
      "cv_pi_12": "CV that offsets instrument 13's PITCH (linear).",
      "cv_pi_13": "CV that offsets instrument 14's PITCH (linear).",
      "cv_pi_14": "CV that offsets instrument 15's PITCH (linear).",
      "cv_pi_15": "CV that offsets instrument 16's PITCH (linear).",
      "cv_pi_2": "CV that offsets instrument 3's PITCH (linear).",
      "cv_pi_3": "CV that offsets instrument 4's PITCH (linear).",
      "cv_pi_4": "CV that offsets instrument 5's PITCH (linear).",
      "cv_pi_5": "CV that offsets instrument 6's PITCH (linear).",
      "cv_pi_6": "CV that offsets instrument 7's PITCH (linear).",
      "cv_pi_7": "CV that offsets instrument 8's PITCH (linear).",
      "cv_pi_8": "CV that offsets instrument 9's PITCH (linear).",
      "cv_pi_9": "CV that offsets instrument 10's PITCH (linear).",
      "cv_q_0": "CV that offsets instrument 1's filter RESONANCE/Q (log).",
      "cv_q_1": "CV that offsets instrument 2's filter RESONANCE/Q (log).",
      "cv_q_10": "CV that offsets instrument 11's filter RESONANCE/Q (log).",
      "cv_q_11": "CV that offsets instrument 12's filter RESONANCE/Q (log).",
      "cv_q_12": "CV that offsets instrument 13's filter RESONANCE/Q (log).",
      "cv_q_13": "CV that offsets instrument 14's filter RESONANCE/Q (log).",
      "cv_q_14": "CV that offsets instrument 15's filter RESONANCE/Q (log).",
      "cv_q_15": "CV that offsets instrument 16's filter RESONANCE/Q (log).",
      "cv_q_2": "CV that offsets instrument 3's filter RESONANCE/Q (log).",
      "cv_q_3": "CV that offsets instrument 4's filter RESONANCE/Q (log).",
      "cv_q_4": "CV that offsets instrument 5's filter RESONANCE/Q (log).",
      "cv_q_5": "CV that offsets instrument 6's filter RESONANCE/Q (log).",
      "cv_q_6": "CV that offsets instrument 7's filter RESONANCE/Q (log).",
      "cv_q_7": "CV that offsets instrument 8's filter RESONANCE/Q (log).",
      "cv_q_8": "CV that offsets instrument 9's filter RESONANCE/Q (log).",
      "cv_q_9": "CV that offsets instrument 10's filter RESONANCE/Q (log).",
      "cv_r_0": "CV that offsets instrument 1's envelope RELEASE (log).",
      "cv_r_1": "CV that offsets instrument 2's envelope RELEASE (log).",
      "cv_r_10": "CV that offsets instrument 11's envelope RELEASE (log).",
      "cv_r_11": "CV that offsets instrument 12's envelope RELEASE (log).",
      "cv_r_12": "CV that offsets instrument 13's envelope RELEASE (log).",
      "cv_r_13": "CV that offsets instrument 14's envelope RELEASE (log).",
      "cv_r_14": "CV that offsets instrument 15's envelope RELEASE (log).",
      "cv_r_15": "CV that offsets instrument 16's envelope RELEASE (log).",
      "cv_r_2": "CV that offsets instrument 3's envelope RELEASE (log).",
      "cv_r_3": "CV that offsets instrument 4's envelope RELEASE (log).",
      "cv_r_4": "CV that offsets instrument 5's envelope RELEASE (log).",
      "cv_r_5": "CV that offsets instrument 6's envelope RELEASE (log).",
      "cv_r_6": "CV that offsets instrument 7's envelope RELEASE (log).",
      "cv_r_7": "CV that offsets instrument 8's envelope RELEASE (log).",
      "cv_r_8": "CV that offsets instrument 9's envelope RELEASE (log).",
      "cv_r_9": "CV that offsets instrument 10's envelope RELEASE (log).",
      "cv_s_0": "CV that offsets instrument 1's envelope SUSTAIN (linear).",
      "cv_s_1": "CV that offsets instrument 2's envelope SUSTAIN (linear).",
      "cv_s_10": "CV that offsets instrument 11's envelope SUSTAIN (linear).",
      "cv_s_11": "CV that offsets instrument 12's envelope SUSTAIN (linear).",
      "cv_s_12": "CV that offsets instrument 13's envelope SUSTAIN (linear).",
      "cv_s_13": "CV that offsets instrument 14's envelope SUSTAIN (linear).",
      "cv_s_14": "CV that offsets instrument 15's envelope SUSTAIN (linear).",
      "cv_s_15": "CV that offsets instrument 16's envelope SUSTAIN (linear).",
      "cv_s_2": "CV that offsets instrument 3's envelope SUSTAIN (linear).",
      "cv_s_3": "CV that offsets instrument 4's envelope SUSTAIN (linear).",
      "cv_s_4": "CV that offsets instrument 5's envelope SUSTAIN (linear).",
      "cv_s_5": "CV that offsets instrument 6's envelope SUSTAIN (linear).",
      "cv_s_6": "CV that offsets instrument 7's envelope SUSTAIN (linear).",
      "cv_s_7": "CV that offsets instrument 8's envelope SUSTAIN (linear).",
      "cv_s_8": "CV that offsets instrument 9's envelope SUSTAIN (linear).",
      "cv_s_9": "CV that offsets instrument 10's envelope SUSTAIN (linear).",
      "cv_vol_0": "CV that offsets instrument 1's VOLUME (linear).",
      "cv_vol_1": "CV that offsets instrument 2's VOLUME (linear).",
      "cv_vol_10": "CV that offsets instrument 11's VOLUME (linear).",
      "cv_vol_11": "CV that offsets instrument 12's VOLUME (linear).",
      "cv_vol_12": "CV that offsets instrument 13's VOLUME (linear).",
      "cv_vol_13": "CV that offsets instrument 14's VOLUME (linear).",
      "cv_vol_14": "CV that offsets instrument 15's VOLUME (linear).",
      "cv_vol_15": "CV that offsets instrument 16's VOLUME (linear).",
      "cv_vol_2": "CV that offsets instrument 3's VOLUME (linear).",
      "cv_vol_3": "CV that offsets instrument 4's VOLUME (linear).",
      "cv_vol_4": "CV that offsets instrument 5's VOLUME (linear).",
      "cv_vol_5": "CV that offsets instrument 6's VOLUME (linear).",
      "cv_vol_6": "CV that offsets instrument 7's VOLUME (linear).",
      "cv_vol_7": "CV that offsets instrument 8's VOLUME (linear).",
      "cv_vol_8": "CV that offsets instrument 9's VOLUME (linear).",
      "cv_vol_9": "CV that offsets instrument 10's VOLUME (linear).",
      ...
      "trig0": "Instrument 1 direct TRIGGER — a rising edge fires this voice once (one hit), independent of the step grid. Patch a sequencer/clock here to play this drum directly.",
      "trig1": "Instrument 2 direct TRIGGER — a rising edge fires this voice once (one hit), independent of the step grid. Patch a sequencer/clock here to play this drum directly.",
      "trig10": "Instrument 11 direct TRIGGER — a rising edge fires this voice once (one hit), independent of the step grid. Patch a sequencer/clock here to play this drum directly.",
      "trig11": "Instrument 12 direct TRIGGER — a rising edge fires this voice once (one hit), independent of the step grid. Patch a sequencer/clock here to play this drum directly.",
      "trig12": "Instrument 13 direct TRIGGER — a rising edge fires this voice once (one hit), independent of the step grid. Patch a sequencer/clock here to play this drum directly.",
      "trig13": "Instrument 14 direct TRIGGER — a rising edge fires this voice once (one hit), independent of the step grid. Patch a sequencer/clock here to play this drum directly.",
      "trig14": "Instrument 15 direct TRIGGER — a rising edge fires this voice once (one hit), independent of the step grid. Patch a sequencer/clock here to play this drum directly.",
      "trig15": "Instrument 16 direct TRIGGER — a rising edge fires this voice once (one hit), independent of the step grid. Patch a sequencer/clock here to play this drum directly.",
      "trig2": "Instrument 3 direct TRIGGER — a rising edge fires this voice once (one hit), independent of the step grid. Patch a sequencer/clock here to play this drum directly.",
      "trig3": "Instrument 4 direct TRIGGER — a rising edge fires this voice once (one hit), independent of the step grid. Patch a sequencer/clock here to play this drum directly.",
      "trig4": "Instrument 5 direct TRIGGER — a rising edge fires this voice once (one hit), independent of the step grid. Patch a sequencer/clock here to play this drum directly.",
      "trig5": "Instrument 6 direct TRIGGER — a rising edge fires this voice once (one hit), independent of the step grid. Patch a sequencer/clock here to play this drum directly.",
      "trig6": "Instrument 7 direct TRIGGER — a rising edge fires this voice once (one hit), independent of the step grid. Patch a sequencer/clock here to play this drum directly.",
      "trig7": "Instrument 8 direct TRIGGER — a rising edge fires this voice once (one hit), independent of the step grid. Patch a sequencer/clock here to play this drum directly.",
      "trig8": "Instrument 9 direct TRIGGER — a rising edge fires this voice once (one hit), independent of the step grid. Patch a sequencer/clock here to play this drum directly.",
      "trig9": "Instrument 10 direct TRIGGER — a rising edge fires this voice once (one hit), independent of the step grid. Patch a sequencer/clock here to play this drum directly."
    },
    "outputs": {
    ...
    "controls": {
      "A0": "Instrument 1 amp-envelope ATTACK (0..2 s, log) — how fast each hit rises. CV via the cv_a_0 input.",
      "A1": "Instrument 2 amp-envelope ATTACK (0..2 s, log) — how fast each hit rises. CV via the cv_a_1 input.",
      "A10": "Instrument 11 amp-envelope ATTACK (0..2 s, log) — how fast each hit rises. CV via the cv_a_10 input.",
      "A11": "Instrument 12 amp-envelope ATTACK (0..2 s, log) — how fast each hit rises. CV via the cv_a_11 input.",
      "A12": "Instrument 13 amp-envelope ATTACK (0..2 s, log) — how fast each hit rises. CV via the cv_a_12 input.",
      "A13": "Instrument 14 amp-envelope ATTACK (0..2 s, log) — how fast each hit rises. CV via the cv_a_13 input.",
      "A14": "Instrument 15 amp-envelope ATTACK (0..2 s, log) — how fast each hit rises. CV via the cv_a_14 input.",
      "A15": "Instrument 16 amp-envelope ATTACK (0..2 s, log) — how fast each hit rises. CV via the cv_a_15 input.",
      "A2": "Instrument 3 amp-envelope ATTACK (0..2 s, log) — how fast each hit rises. CV via the cv_a_2 input.",
      "A3": "Instrument 4 amp-envelope ATTACK (0..2 s, log) — how fast each hit rises. CV via the cv_a_3 input.",
      "A4": "Instrument 5 amp-envelope ATTACK (0..2 s, log) — how fast each hit rises. CV via the cv_a_4 input.",
      "A5": "Instrument 6 amp-envelope ATTACK (0..2 s, log) — how fast each hit rises. CV via the cv_a_5 input.",
      "A6": "Instrument 7 amp-envelope ATTACK (0..2 s, log) — how fast each hit rises. CV via the cv_a_6 input.",
      "A7": "Instrument 8 amp-envelope ATTACK (0..2 s, log) — how fast each hit rises. CV via the cv_a_7 input.",
      "A8": "Instrument 9 amp-envelope ATTACK (0..2 s, log) — how fast each hit rises. CV via the cv_a_8 input.",
      "A9": "Instrument 10 amp-envelope ATTACK (0..2 s, log) — how fast each hit rises. CV via the cv_a_9 input.",
      "D0": "Instrument 1 amp-envelope DECAY (0..2 s, log) — fall time from the attack peak to the sustain level. CV via the cv_d_0 input.",
      "D1": "Instrument 2 amp-envelope DECAY (0..2 s, log) — fall time from the attack peak to the sustain level. CV via the cv_d_1 input.",
      "D10": "Instrument 11 amp-envelope DECAY (0..2 s, log) — fall time from the attack peak to the sustain level. CV via the cv_d_10 input.",
      "D11": "Instrument 12 amp-envelope DECAY (0..2 s, log) — fall time from the attack peak to the sustain level. CV via the cv_d_11 input.",
      "D12": "Instrument 13 amp-envelope DECAY (0..2 s, log) — fall time from the attack peak to the sustain level. CV via the cv_d_12 input.",
      "D13": "Instrument 14 amp-envelope DECAY (0..2 s, log) — fall time from the attack peak to the sustain level. CV via the cv_d_13 input.",
      "D14": "Instrument 15 amp-envelope DECAY (0..2 s, log) — fall time from the attack peak to the sustain level. CV via the cv_d_14 input.",
      "D15": "Instrument 16 amp-envelope DECAY (0..2 s, log) — fall time from the attack peak to the sustain level. CV via the cv_d_15 input.",
      "D2": "Instrument 3 amp-envelope DECAY (0..2 s, log) — fall time from the attack peak to the sustain level. CV via the cv_d_2 input.",
      "D3": "Instrument 4 amp-envelope DECAY (0..2 s, log) — fall time from the attack peak to the sustain level. CV via the cv_d_3 input.",
      "D4": "Instrument 5 amp-envelope DECAY (0..2 s, log) — fall time from the attack peak to the sustain level. CV via the cv_d_4 input.",
      "D5": "Instrument 6 amp-envelope DECAY (0..2 s, log) — fall time from the attack peak to the sustain level. CV via the cv_d_5 input.",
      "D6": "Instrument 7 amp-envelope DECAY (0..2 s, log) — fall time from the attack peak to the sustain level. CV via the cv_d_6 input.",
      "D7": "Instrument 8 amp-envelope DECAY (0..2 s, log) — fall time from the attack peak to the sustain level. CV via the cv_d_7 input.",
      "D8": "Instrument 9 amp-envelope DECAY (0..2 s, log) — fall time from the attack peak to the sustain level. CV via the cv_d_8 input.",
      "D9": "Instrument 10 amp-envelope DECAY (0..2 s, log) — fall time from the attack peak to the sustain level. CV via the cv_d_9 input.",
      "R0": "Instrument 1 amp-envelope RELEASE (0.01..5 s, log) — fade time after the trigger ends; sets how long the tail rings. CV via the cv_r_0 input.",
      "R1": "Instrument 2 amp-envelope RELEASE (0.01..5 s, log) — fade time after the trigger ends; sets how long the tail rings. CV via the cv_r_1 input.",
      "R10": "Instrument 11 amp-envelope RELEASE (0.01..5 s, log) — fade time after the trigger ends; sets how long the tail rings. CV via the cv_r_10 input.",
      "R11": "Instrument 12 amp-envelope RELEASE (0.01..5 s, log) — fade time after the trigger ends; sets how long the tail rings. CV via the cv_r_11 input.",
      "R12": "Instrument 13 amp-envelope RELEASE (0.01..5 s, log) — fade time after the trigger ends; sets how long the tail rings. CV via the cv_r_12 input.",
      "R13": "Instrument 14 amp-envelope RELEASE (0.01..5 s, log) — fade time after the trigger ends; sets how long the tail rings. CV via the cv_r_13 input.",
      "R14": "Instrument 15 amp-envelope RELEASE (0.01..5 s, log) — fade time after the trigger ends; sets how long the tail rings. CV via the cv_r_14 input.",
      "R15": "Instrument 16 amp-envelope RELEASE (0.01..5 s, log) — fade time after the trigger ends; sets how long the tail rings. CV via the cv_r_15 input.",
      "R2": "Instrument 3 amp-envelope RELEASE (0.01..5 s, log) — fade time after the trigger ends; sets how long the tail rings. CV via the cv_r_2 input.",
      "R3": "Instrument 4 amp-envelope RELEASE (0.01..5 s, log) — fade time after the trigger ends; sets how long the tail rings. CV via the cv_r_3 input.",
      "R4": "Instrument 5 amp-envelope RELEASE (0.01..5 s, log) — fade time after the trigger ends; sets how long the tail rings. CV via the cv_r_4 input.",
      "R5": "Instrument 6 amp-envelope RELEASE (0.01..5 s, log) — fade time after the trigger ends; sets how long the tail rings. CV via the cv_r_5 input.",
      "R6": "Instrument 7 amp-envelope RELEASE (0.01..5 s, log) — fade time after the trigger ends; sets how long the tail rings. CV via the cv_r_6 input.",
      "R7": "Instrument 8 amp-envelope RELEASE (0.01..5 s, log) — fade time after the trigger ends; sets how long the tail rings. CV via the cv_r_7 input.",
      "R8": "Instrument 9 amp-envelope RELEASE (0.01..5 s, log) — fade time after the trigger ends; sets how long the tail rings. CV via the cv_r_8 input.",
      "R9": "Instrument 10 amp-envelope RELEASE (0.01..5 s, log) — fade time after the trigger ends; sets how long the tail rings. CV via the cv_r_9 input.",
      "S0": "Instrument 1 amp-envelope SUSTAIN level (0..1) — the level held while the trigger is high. CV via the cv_s_0 input.",
      "S1": "Instrument 2 amp-envelope SUSTAIN level (0..1) — the level held while the trigger is high. CV via the cv_s_1 input.",
      "S10": "Instrument 11 amp-envelope SUSTAIN level (0..1) — the level held while the trigger is high. CV via the cv_s_10 input.",
      "S11": "Instrument 12 amp-envelope SUSTAIN level (0..1) — the level held while the trigger is high. CV via the cv_s_11 input.",
      "S12": "Instrument 13 amp-envelope SUSTAIN level (0..1) — the level held while the trigger is high. CV via the cv_s_12 input.",
      "S13": "Instrument 14 amp-envelope SUSTAIN level (0..1) — the level held while the trigger is high. CV via the cv_s_13 input.",
      "S14": "Instrument 15 amp-envelope SUSTAIN level (0..1) — the level held while the trigger is high. CV via the cv_s_14 input.",
      "S15": "Instrument 16 amp-envelope SUSTAIN level (0..1) — the level held while the trigger is high. CV via the cv_s_15 input.",
      "S2": "Instrument 3 amp-envelope SUSTAIN level (0..1) — the level held while the trigger is high. CV via the cv_s_2 input.",
      "S3": "Instrument 4 amp-envelope SUSTAIN level (0..1) — the level held while the trigger is high. CV via the cv_s_3 input.",
      "S4": "Instrument 5 amp-envelope SUSTAIN level (0..1) — the level held while the trigger is high. CV via the cv_s_4 input.",
      "S5": "Instrument 6 amp-envelope SUSTAIN level (0..1) — the level held while the trigger is high. CV via the cv_s_5 input.",
      "S6": "Instrument 7 amp-envelope SUSTAIN level (0..1) — the level held while the trigger is high. CV via the cv_s_6 input.",
      "S7": "Instrument 8 amp-envelope SUSTAIN level (0..1) — the level held while the trigger is high. CV via the cv_s_7 input.",
      "S8": "Instrument 9 amp-envelope SUSTAIN level (0..1) — the level held while the trigger is high. CV via the cv_s_8 input.",
      "S9": "Instrument 10 amp-envelope SUSTAIN level (0..1) — the level held while the trigger is high. CV via the cv_s_9 input.",
      ...
      "cutoff0": "Instrument 1 per-voice low-pass CUTOFF (20 Hz..20 kHz, log; default fully open) — darkens this voice. CV via the cv_cf_0 input.",
      "cutoff1": "Instrument 2 per-voice low-pass CUTOFF (20 Hz..20 kHz, log; default fully open) — darkens this voice. CV via the cv_cf_1 input.",
      "cutoff10": "Instrument 11 per-voice low-pass CUTOFF (20 Hz..20 kHz, log; default fully open) — darkens this voice. CV via the cv_cf_10 input.",
      "cutoff11": "Instrument 12 per-voice low-pass CUTOFF (20 Hz..20 kHz, log; default fully open) — darkens this voice. CV via the cv_cf_11 input.",
      "cutoff12": "Instrument 13 per-voice low-pass CUTOFF (20 Hz..20 kHz, log; default fully open) — darkens this voice. CV via the cv_cf_12 input.",
      "cutoff13": "Instrument 14 per-voice low-pass CUTOFF (20 Hz..20 kHz, log; default fully open) — darkens this voice. CV via the cv_cf_13 input.",
      "cutoff14": "Instrument 15 per-voice low-pass CUTOFF (20 Hz..20 kHz, log; default fully open) — darkens this voice. CV via the cv_cf_14 input.",
      "cutoff15": "Instrument 16 per-voice low-pass CUTOFF (20 Hz..20 kHz, log; default fully open) — darkens this voice. CV via the cv_cf_15 input.",
      "cutoff2": "Instrument 3 per-voice low-pass CUTOFF (20 Hz..20 kHz, log; default fully open) — darkens this voice. CV via the cv_cf_2 input.",
      "cutoff3": "Instrument 4 per-voice low-pass CUTOFF (20 Hz..20 kHz, log; default fully open) — darkens this voice. CV via the cv_cf_3 input.",
      "cutoff4": "Instrument 5 per-voice low-pass CUTOFF (20 Hz..20 kHz, log; default fully open) — darkens this voice. CV via the cv_cf_4 input.",
      "cutoff5": "Instrument 6 per-voice low-pass CUTOFF (20 Hz..20 kHz, log; default fully open) — darkens this voice. CV via the cv_cf_5 input.",
      "cutoff6": "Instrument 7 per-voice low-pass CUTOFF (20 Hz..20 kHz, log; default fully open) — darkens this voice. CV via the cv_cf_6 input.",
      "cutoff7": "Instrument 8 per-voice low-pass CUTOFF (20 Hz..20 kHz, log; default fully open) — darkens this voice. CV via the cv_cf_7 input.",
      "cutoff8": "Instrument 9 per-voice low-pass CUTOFF (20 Hz..20 kHz, log; default fully open) — darkens this voice. CV via the cv_cf_8 input.",
      "cutoff9": "Instrument 10 per-voice low-pass CUTOFF (20 Hz..20 kHz, log; default fully open) — darkens this voice. CV via the cv_cf_9 input.",
      ...
      "mute0": "Instrument 1 MUTE (the row's M button) — silences this instrument when on, without erasing its pattern.",
      "mute1": "Instrument 2 MUTE (the row's M button) — silences this instrument when on, without erasing its pattern.",
      "mute10": "Instrument 11 MUTE (the row's M button) — silences this instrument when on, without erasing its pattern.",
      "mute11": "Instrument 12 MUTE (the row's M button) — silences this instrument when on, without erasing its pattern.",
      "mute12": "Instrument 13 MUTE (the row's M button) — silences this instrument when on, without erasing its pattern.",
      "mute13": "Instrument 14 MUTE (the row's M button) — silences this instrument when on, without erasing its pattern.",
      "mute14": "Instrument 15 MUTE (the row's M button) — silences this instrument when on, without erasing its pattern.",
      "mute15": "Instrument 16 MUTE (the row's M button) — silences this instrument when on, without erasing its pattern.",
      "mute2": "Instrument 3 MUTE (the row's M button) — silences this instrument when on, without erasing its pattern.",
      "mute3": "Instrument 4 MUTE (the row's M button) — silences this instrument when on, without erasing its pattern.",
      "mute4": "Instrument 5 MUTE (the row's M button) — silences this instrument when on, without erasing its pattern.",
      "mute5": "Instrument 6 MUTE (the row's M button) — silences this instrument when on, without erasing its pattern.",
      "mute6": "Instrument 7 MUTE (the row's M button) — silences this instrument when on, without erasing its pattern.",
      "mute7": "Instrument 8 MUTE (the row's M button) — silences this instrument when on, without erasing its pattern.",
      "mute8": "Instrument 9 MUTE (the row's M button) — silences this instrument when on, without erasing its pattern.",
      "mute9": "Instrument 10 MUTE (the row's M button) — silences this instrument when on, without erasing its pattern.",
      "pan0": "Instrument 1 PAN (−1 left .. +1 right) in the stereo field. CV via the cv_pan_0 input.",
      "pan1": "Instrument 2 PAN (−1 left .. +1 right) in the stereo field. CV via the cv_pan_1 input.",
      "pan10": "Instrument 11 PAN (−1 left .. +1 right) in the stereo field. CV via the cv_pan_10 input.",
      "pan11": "Instrument 12 PAN (−1 left .. +1 right) in the stereo field. CV via the cv_pan_11 input.",
      "pan12": "Instrument 13 PAN (−1 left .. +1 right) in the stereo field. CV via the cv_pan_12 input.",
      "pan13": "Instrument 14 PAN (−1 left .. +1 right) in the stereo field. CV via the cv_pan_13 input.",
      "pan14": "Instrument 15 PAN (−1 left .. +1 right) in the stereo field. CV via the cv_pan_14 input.",
      "pan15": "Instrument 16 PAN (−1 left .. +1 right) in the stereo field. CV via the cv_pan_15 input.",
      "pan2": "Instrument 3 PAN (−1 left .. +1 right) in the stereo field. CV via the cv_pan_2 input.",
      "pan3": "Instrument 4 PAN (−1 left .. +1 right) in the stereo field. CV via the cv_pan_3 input.",
      "pan4": "Instrument 5 PAN (−1 left .. +1 right) in the stereo field. CV via the cv_pan_4 input.",
      "pan5": "Instrument 6 PAN (−1 left .. +1 right) in the stereo field. CV via the cv_pan_5 input.",
      "pan6": "Instrument 7 PAN (−1 left .. +1 right) in the stereo field. CV via the cv_pan_6 input.",
      "pan7": "Instrument 8 PAN (−1 left .. +1 right) in the stereo field. CV via the cv_pan_7 input.",
      "pan8": "Instrument 9 PAN (−1 left .. +1 right) in the stereo field. CV via the cv_pan_8 input.",
      "pan9": "Instrument 10 PAN (−1 left .. +1 right) in the stereo field. CV via the cv_pan_9 input.",
      "pitch0": "Instrument 1 PITCH offset in semitones (−24..+24) — repitch the drum sample/voice up or down. CV via the cv_pi_0 input.",
      "pitch1": "Instrument 2 PITCH offset in semitones (−24..+24) — repitch the drum sample/voice up or down. CV via the cv_pi_1 input.",
      "pitch10": "Instrument 11 PITCH offset in semitones (−24..+24) — repitch the drum sample/voice up or down. CV via the cv_pi_10 input.",
      "pitch11": "Instrument 12 PITCH offset in semitones (−24..+24) — repitch the drum sample/voice up or down. CV via the cv_pi_11 input.",
      "pitch12": "Instrument 13 PITCH offset in semitones (−24..+24) — repitch the drum sample/voice up or down. CV via the cv_pi_12 input.",
      "pitch13": "Instrument 14 PITCH offset in semitones (−24..+24) — repitch the drum sample/voice up or down. CV via the cv_pi_13 input.",
      "pitch14": "Instrument 15 PITCH offset in semitones (−24..+24) — repitch the drum sample/voice up or down. CV via the cv_pi_14 input.",
      "pitch15": "Instrument 16 PITCH offset in semitones (−24..+24) — repitch the drum sample/voice up or down. CV via the cv_pi_15 input.",
      "pitch2": "Instrument 3 PITCH offset in semitones (−24..+24) — repitch the drum sample/voice up or down. CV via the cv_pi_2 input.",
      "pitch3": "Instrument 4 PITCH offset in semitones (−24..+24) — repitch the drum sample/voice up or down. CV via the cv_pi_3 input.",
      "pitch4": "Instrument 5 PITCH offset in semitones (−24..+24) — repitch the drum sample/voice up or down. CV via the cv_pi_4 input.",
      "pitch5": "Instrument 6 PITCH offset in semitones (−24..+24) — repitch the drum sample/voice up or down. CV via the cv_pi_5 input.",
      "pitch6": "Instrument 7 PITCH offset in semitones (−24..+24) — repitch the drum sample/voice up or down. CV via the cv_pi_6 input.",
      "pitch7": "Instrument 8 PITCH offset in semitones (−24..+24) — repitch the drum sample/voice up or down. CV via the cv_pi_7 input.",
      "pitch8": "Instrument 9 PITCH offset in semitones (−24..+24) — repitch the drum sample/voice up or down. CV via the cv_pi_8 input.",
      "pitch9": "Instrument 10 PITCH offset in semitones (−24..+24) — repitch the drum sample/voice up or down. CV via the cv_pi_9 input.",
      "q0": "Instrument 1 filter RESONANCE/Q (0.1..20) — emphasis at the cutoff frequency. CV via the cv_q_0 input.",
      "q1": "Instrument 2 filter RESONANCE/Q (0.1..20) — emphasis at the cutoff frequency. CV via the cv_q_1 input.",
      "q10": "Instrument 11 filter RESONANCE/Q (0.1..20) — emphasis at the cutoff frequency. CV via the cv_q_10 input.",
      "q11": "Instrument 12 filter RESONANCE/Q (0.1..20) — emphasis at the cutoff frequency. CV via the cv_q_11 input.",
      "q12": "Instrument 13 filter RESONANCE/Q (0.1..20) — emphasis at the cutoff frequency. CV via the cv_q_12 input.",
      "q13": "Instrument 14 filter RESONANCE/Q (0.1..20) — emphasis at the cutoff frequency. CV via the cv_q_13 input.",
      "q14": "Instrument 15 filter RESONANCE/Q (0.1..20) — emphasis at the cutoff frequency. CV via the cv_q_14 input.",
      "q15": "Instrument 16 filter RESONANCE/Q (0.1..20) — emphasis at the cutoff frequency. CV via the cv_q_15 input.",
      "q2": "Instrument 3 filter RESONANCE/Q (0.1..20) — emphasis at the cutoff frequency. CV via the cv_q_2 input.",
      "q3": "Instrument 4 filter RESONANCE/Q (0.1..20) — emphasis at the cutoff frequency. CV via the cv_q_3 input.",
      "q4": "Instrument 5 filter RESONANCE/Q (0.1..20) — emphasis at the cutoff frequency. CV via the cv_q_4 input.",
      "q5": "Instrument 6 filter RESONANCE/Q (0.1..20) — emphasis at the cutoff frequency. CV via the cv_q_5 input.",
      "q6": "Instrument 7 filter RESONANCE/Q (0.1..20) — emphasis at the cutoff frequency. CV via the cv_q_6 input.",
      "q7": "Instrument 8 filter RESONANCE/Q (0.1..20) — emphasis at the cutoff frequency. CV via the cv_q_7 input.",
      "q8": "Instrument 9 filter RESONANCE/Q (0.1..20) — emphasis at the cutoff frequency. CV via the cv_q_8 input.",
      "q9": "Instrument 10 filter RESONANCE/Q (0.1..20) — emphasis at the cutoff frequency. CV via the cv_q_9 input.",
      "solo0": "Instrument 1 SOLO (the row's S button) — when any instrument is soloed only soloed instruments sound; un-solo to hear the full kit again.",
      "solo1": "Instrument 2 SOLO (the row's S button) — when any instrument is soloed only soloed instruments sound; un-solo to hear the full kit again.",
      "solo10": "Instrument 11 SOLO (the row's S button) — when any instrument is soloed only soloed instruments sound; un-solo to hear the full kit again.",
      "solo11": "Instrument 12 SOLO (the row's S button) — when any instrument is soloed only soloed instruments sound; un-solo to hear the full kit again.",
      "solo12": "Instrument 13 SOLO (the row's S button) — when any instrument is soloed only soloed instruments sound; un-solo to hear the full kit again.",
      "solo13": "Instrument 14 SOLO (the row's S button) — when any instrument is soloed only soloed instruments sound; un-solo to hear the full kit again.",
      "solo14": "Instrument 15 SOLO (the row's S button) — when any instrument is soloed only soloed instruments sound; un-solo to hear the full kit again.",
      "solo15": "Instrument 16 SOLO (the row's S button) — when any instrument is soloed only soloed instruments sound; un-solo to hear the full kit again.",
      "solo2": "Instrument 3 SOLO (the row's S button) — when any instrument is soloed only soloed instruments sound; un-solo to hear the full kit again.",
      "solo3": "Instrument 4 SOLO (the row's S button) — when any instrument is soloed only soloed instruments sound; un-solo to hear the full kit again.",
      "solo4": "Instrument 5 SOLO (the row's S button) — when any instrument is soloed only soloed instruments sound; un-solo to hear the full kit again.",
      "solo5": "Instrument 6 SOLO (the row's S button) — when any instrument is soloed only soloed instruments sound; un-solo to hear the full kit again.",
      "solo6": "Instrument 7 SOLO (the row's S button) — when any instrument is soloed only soloed instruments sound; un-solo to hear the full kit again.",
      "solo7": "Instrument 8 SOLO (the row's S button) — when any instrument is soloed only soloed instruments sound; un-solo to hear the full kit again.",
      "solo8": "Instrument 9 SOLO (the row's S button) — when any instrument is soloed only soloed instruments sound; un-solo to hear the full kit again.",
      "solo9": "Instrument 10 SOLO (the row's S button) — when any instrument is soloed only soloed instruments sound; un-solo to hear the full kit again.",
      ...
      "vol0": "Instrument 1 VOLUME (0..2) — the channel's level into the master mix. CV via the cv_vol_0 input.",
      "vol1": "Instrument 2 VOLUME (0..2) — the channel's level into the master mix. CV via the cv_vol_1 input.",
      "vol10": "Instrument 11 VOLUME (0..2) — the channel's level into the master mix. CV via the cv_vol_10 input.",
      "vol11": "Instrument 12 VOLUME (0..2) — the channel's level into the master mix. CV via the cv_vol_11 input.",
      "vol12": "Instrument 13 VOLUME (0..2) — the channel's level into the master mix. CV via the cv_vol_12 input.",
      "vol13": "Instrument 14 VOLUME (0..2) — the channel's level into the master mix. CV via the cv_vol_13 input.",
      "vol14": "Instrument 15 VOLUME (0..2) — the channel's level into the master mix. CV via the cv_vol_14 input.",
      "vol15": "Instrument 16 VOLUME (0..2) — the channel's level into the master mix. CV via the cv_vol_15 input.",
      "vol2": "Instrument 3 VOLUME (0..2) — the channel's level into the master mix. CV via the cv_vol_2 input.",
      "vol3": "Instrument 4 VOLUME (0..2) — the channel's level into the master mix. CV via the cv_vol_3 input.",
      "vol4": "Instrument 5 VOLUME (0..2) — the channel's level into the master mix. CV via the cv_vol_4 input.",
      "vol5": "Instrument 6 VOLUME (0..2) — the channel's level into the master mix. CV via the cv_vol_5 input.",
      "vol6": "Instrument 7 VOLUME (0..2) — the channel's level into the master mix. CV via the cv_vol_6 input.",
      "vol7": "Instrument 8 VOLUME (0..2) — the channel's level into the master mix. CV via the cv_vol_7 input.",
      "vol8": "Instrument 9 VOLUME (0..2) — the channel's level into the master mix. CV via the cv_vol_8 input.",
      "vol9": "Instrument 10 VOLUME (0..2) — the channel's level into the master mix. CV via the cv_vol_9 input."
    }
  },
  "hypercube": {
  ...
  "polyhelm": {
    "explanation": "POLYHELM is the HELM polyphonic subtractive synth — a faithful port of Matt Tytel's open-source Helm — with a true POLY input bus. It is a full voice: two morphable oscillators plus a sub and a noise source, a multi-mode state-variable filter, three ADSR envelopes (amp / filter / a free 'mod' env), two LFOs, and an internal step sequencer, mixed across up to 8 allocator voices into a stereo output. The whole point vs. plain HELM is the `poly` input: feed it the project's 10-channel poly bus from a real polyphonic source (MIDI LANE in poly mode, POLYSEQZ, or a chord sequencer) and each gated lane lights up its own voice so it plays genuine chords. A mono pitch+gate pair is the single-voice fallback when nothing polyphonic is patched, and a hardware MIDI keyboard can also play it via the card's Web-MIDI gear panel. Every panel knob maps to the same Helm parameter it does in the standalone module, so patches/MIDI-learn transfer.",
    "inputs": {
