...
const DESCRIPTIONS: Record<string, string> = {
  ...
  timelorde: 'Singleton master clock. Internal or external BPM, twelve clock-divider outputs. The card carries a big display of the owl painting whose YELLOW EYES and BLUE BORDER brighten in time with the beat (the body stays steady); patch a feed into VIDEO IN and the display becomes a live monitor while VIDEO OUT passes the feed through (TIMELORDE can sit inline in a video chain).',
  toybox:
