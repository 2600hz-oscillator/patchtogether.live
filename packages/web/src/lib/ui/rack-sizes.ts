...
export const RACK_SIZE_DEFAULTS: Record<string, { size: RackSize; hp: number }> = {
  ...
  painter: { size: '4u', hp: 3 }, // 540×720 — MS-Paint card: 9-tool toolbar + flex-filled 4:3 paint canvas (~520×390) + 28-swatch palette (canvas flexes to the tier; no overflow)
