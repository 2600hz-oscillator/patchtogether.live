...
// FIRST FACE AUTHORED UNDER THE OWNER'S NO-PROSE RULING. Nothing on this panel
// is a sentence: no `face.title`, no `face.hint`, no band caption, no
// signal-flow block. The band header is a plain label and every readout is a
// value and a unit. Everything explanatory went into `docs`, which is what
// right-click → annotate already reads.
//
