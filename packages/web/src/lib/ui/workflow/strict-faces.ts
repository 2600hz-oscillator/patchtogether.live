...
export const STRICT_FACES: ReadonlySet<string> = new Set<string>([
  ...
  // ── TRAILS (bespoke surface, 2026-09-02) — the THIRD MIDI binder promoted,
  //    and the first whose second surface is a PICTURE ────────────────────────
  //
  // ⚠ THE DEFECT PROMOTION FIXES IS THE SAME ONE midiclock's and ptzcam's did,
  // on a module that is inert for one reason rather than two. The Bela Trails is
