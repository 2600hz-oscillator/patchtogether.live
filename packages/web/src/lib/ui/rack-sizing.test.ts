...
// NOTE: backdraft is NOT here any more. It was a FIXED 3u/hp4 tier (#767),
// moved here when it gained FULL OUTPUT CAPABILITIES (corner-resize +
// full-frame/fullscreen/present) because a tier would have CAPPED that resize,
// and is now back to a FIXED 3u/hp5 in RACK_SIZE_DEFAULTS: the in-card preview
// those capabilities existed to scale has been removed, so nothing on the card
// is size-driven and there is no resize left for a tier to cap.
