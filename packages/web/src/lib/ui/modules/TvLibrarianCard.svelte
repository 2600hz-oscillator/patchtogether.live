<script lang="ts">
  ...
  const inputs: PortDescriptor[] = [
    { id: 'next',   cable: 'gate' },
    { id: 'random', cable: 'gate' },
  ];
  const outputs: PortDescriptor[] = [
    { id: 'video',           cable: 'video' },
    { id: 'audio_l',         cable: 'audio' },
    { id: 'audio_r',         cable: 'audio' },
    { id: 'channel_changed', cable: 'gate' },
    { id: 'stream_online',   cable: 'gate' },
  ];
</script>

<div
  class="card video tv-librarian-card"
  class:resizing
