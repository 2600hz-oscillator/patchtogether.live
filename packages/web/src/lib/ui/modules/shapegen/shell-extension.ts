// packages/web/src/lib/ui/modules/shapegen/shell-extension.ts
//
// The SHAPEGEN SHELL EXTENSION — the module-owned end of the extension seam
// (#1512), on the `fullViewBody` slot.
//
// `shapegenDef.face.extension: 'shapegen'` declares this file — the id IS this
// directory's name, and the non-eager glob in
// `$lib/ui/workflow/shell-extensions.ts` is the one resolver. ModuleShell loads
// it lazily and never imports a shapegen component itself, which keeps
...
import ShapegenOutputBody from './ShapegenOutputBody.svelte';

export default {
  fullViewBody: ShapegenOutputBody,
