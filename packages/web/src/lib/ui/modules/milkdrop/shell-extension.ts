// packages/web/src/lib/ui/modules/milkdrop/shell-extension.ts
//
// The MILKDROP SHELL EXTENSION — the module-owned end of the extension seam
...
//
// `milkdropDef.face.extension: 'milkdrop'` declares this file — the id IS
// this directory's name, and the non-eager glob in
// `$lib/ui/workflow/shell-extensions.ts` is the one resolver. ModuleShell loads
// it lazily and never imports a milkdrop component itself, which is what keeps
// `module-shell-import-guard` green.
//
// ⚠ WHY (#1928 / #2009): promotion is what stops BOTH surfaces rendering
// `MilkdropCard.svelte`, and that card is the sole home of the live picture,
...
//
// ⚠ FOURTH ADOPTER OF MONITOR MODE, NOT ITS AUTHOR. `ruttetra` proved the seam
...
import MilkdropOutputBody from './MilkdropOutputBody.svelte';

export default {
  fullViewBody: MilkdropOutputBody,
