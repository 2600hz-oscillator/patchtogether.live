...
<div class="mod-card seq-card">
  ...
  <div class="fader-row">
    ...
    <NeonFader value={length}     min={1}   max={128} defaultValue={16}  label="Len"  curve="discrete" onchange={set('length')} moduleId={id} paramId="length"   readLive={live('length')} />
    ...
    <NeonFader value={swing}      min={0}   max={0.75} defaultValue={0}  label="SWG"  curve="linear" onchange={set('swing')} moduleId={id} paramId="swing"     readLive={live('swing')} />
  </div>
