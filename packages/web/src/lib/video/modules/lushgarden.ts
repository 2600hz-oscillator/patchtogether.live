...
export const lushgardenDef: VideoModuleDef = {
  ...
  docs: {
    ...
    outputs: {
      ...
      clean: "The plain composite — every cutout with its normal image data over the backdrop. This is the canonical output and what the faceplate's preview shows.",
    },
    controls: {
