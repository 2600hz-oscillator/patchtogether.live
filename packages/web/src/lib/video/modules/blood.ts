...
export const bloodDef: VideoModuleDef = {
  ...
  docs: {
    explanation:
      ...
      'canvas. The card boots OUT-OF-BOX: the 1997 Blood SHAREWARE data ("The Way of All ' +
      'Flesh", episode 1) is bundled under static/blood/, so no picker is needed. The ' +
      '"Load full Blood data…" picker is an OPTIONAL override — point it at a copy of the ' +
      'full game you own (GOG/Steam One Unit Whole Blood or Fresh Supply) to play all episodes.',
    inputs: {
