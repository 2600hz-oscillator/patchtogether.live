...
export const chromaDef: VideoModuleDef = {
  ...
  docs: {
    ...
    inputs: {
      ...
      tintR: "CV input that modulates the red channel of the tint color (linear 0..1); also written by the faceplate's color picker.",
      tintG: "CV input that modulates the green channel of the tint color (linear 0..1); also written by the faceplate's color picker.",
      tintB: "CV input that modulates the blue channel of the tint color (linear 0..1); also written by the faceplate's color picker.",
