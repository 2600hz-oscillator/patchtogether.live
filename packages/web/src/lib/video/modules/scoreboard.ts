...
export const scoreboardDef: VideoModuleDef = {
  ...
  docs: {
    ...
    controls: {
      ...
      scoreTrig: "Synthetic gate param (hidden from the faceplate, exposed as the SCORE cv jack via paramTarget). The CV bridge writes incoming gate values here via setParam, and the factory's hysteresis edge detector turns each rising edge into a +1 increment, wrapping at 10000 back to 0.",
