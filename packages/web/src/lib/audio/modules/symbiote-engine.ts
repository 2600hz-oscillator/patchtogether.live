// packages/web/src/lib/audio/modules/symbiote-engine.ts
//
// HOST-SIDE MIRROR of packages/dsp/src/symbiote-core.ts — kept numerically
// identical so vitest + ART exercise the same math as the AudioWorklet.
// IF YOU EDIT THIS FILE, also edit packages/dsp/src/symbiote-core.ts.
//
...
import { cellVoltage, type Scale } from './marbles-engine';
