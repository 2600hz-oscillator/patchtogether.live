...
// Tides 2018 archetype, Émilie Gillet, MIT-licensed). HOST-SIDE COPY of
// packages/dsp/src/tides2-engine.ts — kept numerically identical so the host
// (vitest pass, ART scenarios) and the AudioWorklet pass the same math.
// Following the project convention used by stages / peaks / clouds: dsp-side
// engine for the worklet, web-side mirror for hosts that can't import across
// the worklet bundling boundary.
//
// IF YOU EDIT THIS FILE, also edit packages/dsp/src/tides2-engine.ts.
//
// -----------------------------------------------------------------------------
