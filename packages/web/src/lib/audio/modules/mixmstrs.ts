...
export const mixmstrsDef: AudioModuleDef = {
  ...
  async factory(ctx, node): Promise<AudioDomainNodeHandle> {
    ...
    // connected. A cable leaving either of that lane's audio{N}L/R jacks, to
    // any destination, replaces the internal stereo return, preventing
