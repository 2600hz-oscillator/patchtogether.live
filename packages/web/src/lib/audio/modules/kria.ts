...
export const kriaDef: AudioModuleDef = {
  ...
  docs: {
    ...
    controls: {
      ...
      running:
        "Local play/stop transport (1 = running, 0 = stopped), exposed as the faceplate's RUN button. When a TIMELORDE node exists its run state drives playback instead, and an external clock's pulses can run the tracks regardless.",
      "kria-cell-{n}":
