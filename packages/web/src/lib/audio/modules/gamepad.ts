...
export const gamepadDef: AudioModuleDef = {
  ...
  outputs: [
    ...
    { id: 'rb',    type: 'gate', edge: 'gate' },
    { id: 'a',     type: 'gate', edge: 'gate' },
    { id: 'b',     type: 'gate', edge: 'gate' },
    { id: 'x',     type: 'gate', edge: 'gate' },
    { id: 'y',     type: 'gate', edge: 'gate' },
    { id: 'du',    type: 'gate', edge: 'gate' },
    { id: 'dd',    type: 'gate', edge: 'gate' },
    { id: 'dl',    type: 'gate', edge: 'gate' },
    { id: 'dr',    type: 'gate', edge: 'gate' },
