...
const PORT_IDS = ['play_cv', 'reset_cv', 'queue1_cv', 'queue2_cv', 'queue3_cv', 'queue4_cv'] as const;
...
export function createTransportCv(ctx: AudioContext): TransportCvNodes {
...
/** The 6 input-port descriptors module defs need to declare. */
