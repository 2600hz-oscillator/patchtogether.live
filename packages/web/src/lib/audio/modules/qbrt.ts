...
import wasmUrl from '@inet.modular/dsp/dist/qbrt.wasm?url';
import metaUrl from '@inet.modular/dsp/dist/qbrt.json?url';
import workletUrl from '@inet.modular/dsp/dist/qbrt.worklet.js?url';
