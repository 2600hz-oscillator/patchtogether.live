...
export const kickdrumDef: AudioModuleDef = {
  ...
  docs: {
    ...
    controls: {
      ...
      translate: "SUB: the TRANSLATE harmonic exciter (0–1) — the sub layer's small-speaker reconstructor. It saturates a low-passed copy of the sub to synthesize its 2nd/3rd/4th harmonics (e.g. 80/120/160 Hz for a 40 Hz fundamental), so speakers that can't reproduce the fundamental still read the kick as deep. Raise it when Tune is very low.",
