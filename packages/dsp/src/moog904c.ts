...
// (docs/adr/018-moog-clone-provenance.md). The 904C is the "filter
// coupler": it pairs a 904A-style transistor-ladder
...
// CC-BY-SA musicdsp model, or any Moog schematic.
//
