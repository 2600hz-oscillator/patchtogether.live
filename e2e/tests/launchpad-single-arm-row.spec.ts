...
//
// SINGLE-UNIT two-handed ARM ROW — the cross-view-combo proof (PR #892). ONE
...
// TIMELORDE→clipplayer→VCO→VCA→SCOPE chain). Never touches the pair's two-device
// cross-hold; same decode/dispatch path as hardware (installSimulatedLaunchpad-
// Single + the CC-98 view flip). This is the real-source-chain proof per
// CLAUDE.md: a pasted/new clip actually plays, not "a data.clips key exists".
