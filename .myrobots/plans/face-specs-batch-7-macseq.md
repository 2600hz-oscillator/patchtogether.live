...
>   declared gaps.
> - **The gate READOUT defect is FIXED (#1484)** — `read('gateValue')` now resolves
>   off the same timeline as the AudioParam instead of a mirror written a whole
>   200 ms lookahead early. With PF-22 above, macseq's structural blocker is gone.
