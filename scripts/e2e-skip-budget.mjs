...
export const SKIP_BUDGET = [
  ...
  },
  {
    ...
    why:
      ...
      + 'NEITHER IS TRUE: this file has exactly ONE other macroblock leg (:623, "sustained feedback '
      ...
      + 'audio harness. WHAT ACTUALLY STILL COVERS vfpga, checked: the per-program loop at :333 '
