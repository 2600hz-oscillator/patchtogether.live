...
ydoc.transact(() => {
  ...
  //    (a_band{1..4}_env_slow) become cv1..cv4 for GIBRIBBON. A small master
  //    + per-band lift so the slow envelopes reach GIB's spawn threshold on
  //    energetic steps (tuned against GIB_TUNING in gibribbon-events.ts).
